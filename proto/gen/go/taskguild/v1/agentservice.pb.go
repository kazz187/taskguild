...
type Agent struct {
	...
	MemoryPath       string                 `protobuf:"bytes,4,opt,name=memory_path,json=memoryPath,proto3" json:"memory_path,omitempty"`
	Status           AgentStatus            `protobuf:"varint,5,opt,name=status,proto3,enum=taskguild.v1.AgentStatus" json:"status,omitempty"`
	...
	Triggers         []*EventTrigger        `protobuf:"bytes,8,rep,name=triggers,proto3" json:"triggers,omitempty"`
	ApprovalRequired []*ApprovalRule        `protobuf:"bytes,9,rep,name=approval_required,json=approvalRequired,proto3" json:"approval_required,omitempty"`
	Scaling          *ScalingConfig         `protobuf:"bytes,10,opt,name=scaling,proto3" json:"scaling,omitempty"`
...
func (x *Agent) GetMemoryPath() string {
	if x != nil {
		return x.MemoryPath
	}
	return ""
...
func (x *ScaleAgentRequest) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
const file_taskguild_v1_agentservice_proto_rawDesc = "" +
	"\n" +
	"\x1ftaskguild/v1/agentservice.proto\x12\ftaskguild.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xff\x03\n" +
	"\x05Agent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04role\x18\x02 \x01(\tR\x04role\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\x12\x1f\n" +
	"\vmemory_path\x18\x04 \x01(\tR\n" +
	"memoryPath\x121\n" +
	"\x06status\x18\x05 \x01(\x0e2\x19.taskguild.v1.AgentStatusR\x06status\x12\x17\n" +
	"\atask_id\x18\x06 \x01(\tR\x06taskId\x12#\n" +
	"\rworktree_path\x18\a \x01(\tR\fworktreePath\x126\n" +
	"\btriggers\x18\b \x03(\v2\x1a.taskguild.v1.EventTriggerR\btriggers\x12G\n" +
	"\x11approval_required\x18\t \x03(\v2\x1a.taskguild.v1.ApprovalRuleR\x10approvalRequired\x125\n" +
	"\ascaling\x18\n" +
	" \x01(\v2\x1b.taskguild.v1.ScalingConfigR\ascaling\x129\n" +
	"\n" +
