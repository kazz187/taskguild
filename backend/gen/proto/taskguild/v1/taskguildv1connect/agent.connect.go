...
const (
	...
	// RPC.
	AgentServiceCreateAgentProcedure = "/taskguild.v1.AgentService/CreateAgent"
	...
	// RPC.
	AgentServiceUpdateAgentProcedure = "/taskguild.v1.AgentService/UpdateAgent"
	// AgentServiceDeleteAgentProcedure is the fully-qualified name of the AgentService's DeleteAgent
	// RPC.
	AgentServiceDeleteAgentProcedure = "/taskguild.v1.AgentService/DeleteAgent"
	// AgentServiceSyncAgentsFromDirProcedure is the fully-qualified name of the AgentService's
	// SyncAgentsFromDir RPC.
	AgentServiceSyncAgentsFromDirProcedure = "/taskguild.v1.AgentService/SyncAgentsFromDir"
)
...
type AgentServiceClient interface {
	...
	SyncAgentsFromDir(context.Context, *connect.Request[v1.SyncAgentsFromDirRequest]) (*connect.Response[v1.SyncAgentsFromDirResponse], error)
}
...
func NewAgentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AgentServiceClient {
	...
	agentServiceMethods := v1.File_taskguild_v1_agent_proto.Services().ByName("AgentService").Methods()
	return &agentServiceClient{
		...
		syncAgentsFromDir: connect.NewClient[v1.SyncAgentsFromDirRequest, v1.SyncAgentsFromDirResponse](
			httpClient,
			baseURL+AgentServiceSyncAgentsFromDirProcedure,
			connect.WithSchema(agentServiceMethods.ByName("SyncAgentsFromDir")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type agentServiceClient struct {
	...
	syncAgentsFromDir *connect.Client[v1.SyncAgentsFromDirRequest, v1.SyncAgentsFromDirResponse]
}

// CreateAgent calls taskguild.v1.AgentService.CreateAgent.
...
// UpdateAgent calls taskguild.v1.AgentService.UpdateAgent.
...
// DeleteAgent calls taskguild.v1.AgentService.DeleteAgent.
...
// SyncAgentsFromDir calls taskguild.v1.AgentService.SyncAgentsFromDir.
func (c *agentServiceClient) SyncAgentsFromDir(ctx context.Context, req *connect.Request[v1.SyncAgentsFromDirRequest]) (*connect.Response[v1.SyncAgentsFromDirResponse], error) {
	return c.syncAgentsFromDir.CallUnary(ctx, req)
}
...
func NewAgentServiceHandler(svc AgentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	agentServiceSyncAgentsFromDirHandler := connect.NewUnaryHandler(
		AgentServiceSyncAgentsFromDirProcedure,
		svc.SyncAgentsFromDir,
		connect.WithSchema(agentServiceMethods.ByName("SyncAgentsFromDir")),
		connect.WithHandlerOptions(opts...),
	)
	return "/taskguild.v1.AgentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case AgentServiceSyncAgentsFromDirProcedure:
			agentServiceSyncAgentsFromDirHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedAgentServiceHandler) CreateAgent(context.Context, *connect.Request[v1.CreateAgentRequest]) (*connect.Response[v1.CreateAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("taskguild.v1.AgentService.CreateAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) UpdateAgent(context.Context, *connect.Request[v1.UpdateAgentRequest]) (*connect.Response[v1.UpdateAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("taskguild.v1.AgentService.UpdateAgent is not implemented"))
}
...
func (UnimplementedAgentServiceHandler) DeleteAgent(context.Context, *connect.Request[v1.DeleteAgentRequest]) (*connect.Response[v1.DeleteAgentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("taskguild.v1.AgentService.DeleteAgent is not implemented"))
}

func (UnimplementedAgentServiceHandler) SyncAgentsFromDir(context.Context, *connect.Request[v1.SyncAgentsFromDirRequest]) (*connect.Response[v1.SyncAgentsFromDirResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("taskguild.v1.AgentService.SyncAgentsFromDir is not implemented"))
}
